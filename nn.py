...
def main():
    ...
    for sector in [1, 2, 3, 4, 5, 6]:
        ...
        data = preprocessing.over_sampling(data, cut_len, 4)
        data_rev = preprocessing.over_sampling(data_rev, cut_len, 4)
    ...
    h5path = os.path.join(modeldir, "model_tmp.h5")
    npzpath = os.path.join(modeldir, "model_tmp.npz")
